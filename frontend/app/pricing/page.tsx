    ...
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-2xl mx-auto px-4 py-16 text-center">
        <div className="w-14 h-14 bg-gov-500 rounded-xl flex items-center justify-center mx-auto mb-5">
          <Tag className="w-6 h-6 text-gold-400" strokeWidth={2.5} />
        </div>
        <h1 className="text-2xl font-bold text-gov-700 mb-3">Pricing</h1>
        <div className="card p-8">
          <p className="text-gray-700 leading-relaxed mb-6">
            Pricing depends on your product volume, label format (QR or full GS1), and how many
            distributors and regions you need to track. Tell us about your product line and we'll
            put together a quote that fits.
          </p>
