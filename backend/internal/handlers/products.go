...
func (h *ProductHandler) Get(c *fiber.Ctx) error {
	...
	err = h.DB.QueryRow(ctx, `
		SELECT id, name, short_description, full_description, ingredients,
		       usage_instructions, warnings, importer_company, importer_address,
	...
	`, id).Scan(&p.ID, &p.Name, &p.ShortDescription, &p.FullDescription, &p.Ingredients,
		&p.UsageInstructions, &p.Warnings, &p.ImporterCompany, &p.ImporterAddress,
...
func (h *ProductHandler) Create(c *fiber.Ctx) error {
	...
	err := h.DB.QueryRow(ctx, `
		INSERT INTO products (name, short_description, full_description, ingredients,
			usage_instructions, warnings, importer_company, importer_address, importer_phone,
	...
	`, b.Name, b.ShortDescription, b.FullDescription, b.Ingredients,
		b.UsageInstructions, b.Warnings, b.ImporterCompany, b.ImporterAddress, b.ImporterPhone,
...
func (h *ProductHandler) Update(c *fiber.Ctx) error {
	...
	tag, err := h.DB.Exec(ctx, `
		UPDATE products SET
			...
			usage_instructions = $5, warnings = $6, importer_company = $7, importer_address = $8,
			importer_phone = $9, origin_country = $10, volume = $11, license_number = $12,
			barcode = $13, gtin = $14, image_url = $15, is_active = $16
		WHERE id = $17
	`, b.Name, b.ShortDescription, b.FullDescription, b.Ingredients,
		b.UsageInstructions, b.Warnings, b.ImporterCompany, b.ImporterAddress, b.ImporterPhone,
